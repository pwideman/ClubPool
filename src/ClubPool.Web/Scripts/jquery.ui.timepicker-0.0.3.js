...
(function ($, undefined) {
    ...
    function Timepicker() {
        ...
        this._defaults = { // Global defaults for all the time picker instances
            ...
            timeSeparator: 'h', // The caracter to use to separate hours and minutes
            showPeriod: false, // Whether or not to show AM/PM
            showLeadingZero: true // Whether or not to show a leading zero for hours/minutes < 10
        };
    ...
    $.extend(Timepicker.prototype, {
        ...
        _generateHTML: function (inst) {
            ...
            html += '<tr>';
            for (m = 0; m <= 10; m += 5) {
                html += this._generateHTMLMinuteCell(inst, m, (m < 10) && showLeadingZero ? "0" + m.toString() : m.toString());
            }
            html += '</tr><tr>';
            for (m = 15; m <= 25; m += 5) {
