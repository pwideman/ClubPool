...
namespace ClubPool.Web.Controllers
{
  public class RouteRegistrar
  {
    public static void RegisterRoutesTo(RouteCollection routes) {
      ...
      //routes.CreateArea("Organization/Department", "ClubPool.Web.Controllers.Organization.Department",
      ...
      //);
      //routes.CreateArea("Organization", "ClubPool.Web.Controllers.Organization",
      ...
      routes.CreateArea("Root", "ClubPool.Web.Controllers",
